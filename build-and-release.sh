...
docker build -t car2godeveloper/dind-node-build-runner . && \
  ...
  docker tag -f car2godeveloper/dind-node-build-runner car2godeveloper/dind-node-build-runner:$IMAGE_TAG && \
  docker push car2godeveloper/dind-node-build-runner
